...
b.options.multiSort||null===f.order||(d=!0)})}function o(){if(0!==this.options.navigation){var b=j(this.options.css.infos),c=g.call(this,b);if(c.length>0){var d=this.current*this.rowCount,e=a(this.options.templates.infos.resolve(h.call(this,{end:0===this.total||d===-1||d>this.total?this.total:d,start:0===this.total?0:d-this.rowCount+1,total:this.total})));I.call(this,c,e)}}}function p(){var a=this.$element.children("tbody").first(),b=this.options.templates,c=this.columns.where(m).length;this.selection&&c++,a.html(b.noResults.resolve(h.call(this,{columns:c})))}function q(a){this.total=a,this.totalPages=this.rowCount===-1?1:Math.ceil(this.total/this.rowCount)}function r(b,c,d,e){var f=this,g=this.options.templates,i=this.options.css,k=h.call(this,{css:e,text:d,page:c}),l=a(g.paginationItem.resolve(k)).on("click"+O,j(i.paginationButton),function(b){b.stopPropagation(),b.preventDefault();var c=a(this),d=c.parent();if(!d.hasClass("active")&&!d.hasClass("disabled")){var e={first:1,prev:f.current-1,next:f.current+1,last:f.totalPages},g=c.data("page");f.current=e[g]||g,t.call(f)}c.trigger("blur")});return b.append(l),l}function s(){if(0!==this.options.navigation){var b=j(this.options.css.pagination),c=g.call(this,b)._mcmShowAria(this.rowCount!==-1);if(this.rowCount!==-1&&c.length>0){var d=this.options.templates,e=this.current,f=this.totalPages,i=a(d.pagination.resolve(h.call(this))),k=f-e,l=(this.options.padding-e)*-1,m=k>=this.options.padding?Math.max(l,1):Math.max(l-this.options.padding+k,1),n=2*this.options.padding+1,o=f>=n?n:f;r.call(this,i,"first","&laquo;","first")._mcmEnableAria(e>1),r.call(this,i,"prev","&lt;","prev")._mcmEnableAria(e>1);for(var p=0;p<o;p++){var q=p+m;r.call(this,i,q,q,"page-"+q)._mcmEnableAria()._mcmSelectAria(q===e)}0===o&&r.call(this,i,1,1,"page-1")._mcmEnableAria(!1)._mcmSelectAria(),r.call(this,i,"next","&gt;","next")._mcmEnableAria(f>e),r.call(this,i,"last","&raquo;","last")._mcmEnableAria(f>e),I.call(this,c,i)}}}function t(){function c(a){for(var b=new RegExp(f.searchPhrase,f.options.caseSensitive?"g":"gi"),c=0;c<f.columns.length;c++){var d=f.columns[c],e=d.converter.to(a[d.id]);if(d.searchable&&d.visible&&e&&e.search(b)>-1)return!0}return!1}function d(a){for(var b=0;b<f.columns.length;b++){var c=f.columns[b],d=c.converter.to(a[c.id]);if(c.showFilter){if(!c.filterValue)return!0;var e=new RegExp(c.filterValue,f.options.caseSensitive?"g":"gi");if(d&&d.search(e)<=-1)return!1}}return!0}function e(a,b){f.currentRows=a,q.call(f,b),f.options.keepSelection||(f.selectedRows=[]),B.call(f,a),o.call(f),s.call(f),f.$element._mcmBusyAria(!1).trigger("loaded"+O)}// jshint ignore:line
...
if(b.length>0){var c=this,d=this.options.css,e=this.options.templates,f=this.$element.children("tbody").first(),g=!0,i="";a.each(b,function(b,f){var j="",k=' data-row-id="'+(null==c.identifier?b:f[c.identifier])+'"',l="";if(c.selection){var m=a.inArray(f[c.identifier],c.selectedRows)!==-1,n=e.select.resolve(h.call(c,{type:"checkbox",value:f[c.identifier],checked:m}));j+=e.cell.resolve(h.call(c,{content:n,css:d.selectCell,style:"selectCellTdStyle"})),g=g&&m,m&&(l+=d.selected,k+=' aria-selected="true"')}var o=null!=f.colorIndex&&c.options.colorMapping[f.colorIndex];o&&(l+=o),a.each(c.columns,function(b,g){if(g.visible){var i=a.isFunction(g.formatter)?g.formatter.call(c,g,f):g.converter.to(f[g.id]),k=g.cssClass.length>0?" "+g.cssClass:"";j+=e.cell.resolve(h.call(c,{content:null==i||""===i?"&nbsp;":i,css:("right"===g.align?d.right:"center"===g.align?d.center:d.left)+k,style:null==g.width?"":"width:"+g.width+";"}))}}),l.length>0&&(k+=' class="'+l+'"'),i+=e.row.resolve(h.call(c,{attr:k,cells:j}))}),
...
var c=this,d=j(this.options.css.selectBox);this.selection&&b.off("click"+O,d).on("click"+O,d,function(b){b.stopPropagation();var d=a(this),e=c.converter.from(d.val());d.prop("checked")?c.select([e]):c.deselect([e])}),b.off("dblclick"+O,"> tr").on("dblclick"+O,"> tr",function(b){if(a(b.target).is("td")){//don't trigger on links and stuff
b.stopPropagation();var d=a(this),e=null==c.identifier?d.data("row-id"):c.converter.from(d.data("row-id")+""),f=null==c.identifier?c.currentRows[e]:c.currentRows.first(function(a){return a[c.identifier]===e});c.$element.trigger("dblclick"+O,[c.columns,f])}}),b.off("click"+O,"> tr").on("click"+O,"> tr",function(b){if(a(b.target).is("td")){//don't trigger on links and stuff
...
2:"warning",/**
         ...
         * @for colorMapping
         **/
3:"danger",4:"rowColorClass4",5:"rowColorClass5",6:"rowColorClass6",7:"rowColorClass7",8:"rowColorClass8",9:"rowColorClass9",10:"rowColorClass10",11:"rowColorClass11",12:"rowColorClass12",13:"rowColorClass13",14:"rowColorClass14",15:"rowColorClass15",16:"rowColorClass16",17:"rowColorClass17",18:"rowColorClass18",19:"rowColorClass19",20:"rowColorClass20",21:"rowColorClass21",22:"rowColorClass22",23:"rowColorClass23",24:"rowColorClass24",25:"rowColorClass25",26:"rowColorClass26",27:"rowColorClass27",28:"rowColorClass28",29:"rowColorClass29",30:"rowColorClass30",31:"rowColorClass31",32:"rowColorClass32",33:"rowColorClass33",34:"rowColorClass34",35:"rowColorClass35",36:"rowColorClass36",37:"rowColorClass37",38:"rowColorClass38",39:"rowColorClass39",40:"rowColorClass40",41:"rowColorClass41",42:"rowColorClass42"},locales:{},/**
 ...
 * @since 1.0.0
 **/
P.prototype.getColumnSettingsById=function(a){for(var b=0;b<this.columns.length;b++){var c=this.columns[b];if(c.columnId===a)return c}return null},/**
 ...
 * @since 1.0.0
 **/
P.prototype.getTotalPageCount=function(){return this.totalPages},P.prototype.getColumnById=function(b){var c,d=this;return a.each(d.columns,function(a,d){if(d.id===b)return c=d,!1}),c},P.prototype.getRowById=function(b){var c,d=this;return a.each(d.rows,function(a,e){if(d.identifier){if(e[d.identifier]===b)return c=e,!1}else if(e.id===b)return c=e,!1}),c},/**
...
a.extend(a.fn.tablear.Constructor.defaults,{editable:!0,onEditableInit:function(){return!1},onEditableSave:function(a,b,c,d){return!1},onEditableShown:function(a,b,c,d){return!1},onEditableHidden:function(a,b,c,d){return!1}}),a.extend(a.fn.tablear.Constructor.EVENTS,{"editable-init.bs.table":"onEditableInit","editable-save.bs.table":"onEditableSave","editable-shown.bs.table":"onEditableShown","editable-hidden.bs.table":"onEditableHidden"});var b=a.fn.tablear.Constructor.prototype.initExtension;a.fn.tablear.Constructor.prototype.initExtension=function(){var c=this;if(b.apply(this,Array.prototype.slice.apply(arguments)),this.options.editable){var d;a.each(this.columns,function(a,b){if(b.identifier)return d=b.id,!1}),a.each(this.columns,function(b,e){if(e.editable){var f={},g=[],h="editable-",i=function(a,b){
// Replace camel case with dashes.
var c=a.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()});if(c.slice(0,h.length)===h){var d=c.replace(h,"data-");f[d]=b}};a.each(c.options,i);var j=e.formatter;e.formatter=function(b,c,h){
//var result = _formatter ? _formatter(value, row, index) : value;
var k=j?j(b,c,h):c[b.field];return k&&("string"==typeof k||k instanceof String)&&(k=k.replace(/"/g,"&quot;")),a.each(e,i),g=[],a.each(f,function(a,b){g.push(" "+a+'="'+b+'"')}),['<a href="javascript:void(0)"',' data-name="'+e.field+'"',' data-pk="'+c[d]+'"',
//' data-value="' + result + '"',
k?' data-value="'+k+'"':"",g.join(""),"></a>"].join("")}}})}};var c=a.fn.tablear.Constructor.prototype.afterRowsRendered;a.fn.tablear.Constructor.prototype.afterRowsRendered=function(){var b=this;if(c.apply(this,Array.prototype.slice.apply(arguments)),this.options.editable){for(var d=this.columns.length,e=-1,f=d-1;f>=0;f--)if(this.columns[f].visible){e=f;break}a.each(this.columns,function(c,d){if(d.editable){
...
var f=b.$element.find('a[data-name="'+d.field+'"]');f.each(function(){var b={},d=a(this).data("maxYear");d&&(b.maxYear=d);var f=a(this).data("minYear");f&&(b.minYear=f);var g=a(this).data("yearDescending");"undefined"!=typeof g&&(b.yearDescending=g);var h="top";c===e&&(h="left"),a(this).editable({combodate:b,placement:h})}),f.off("save").on("save",b,function(b,c){var d=b.data,e=a(b.currentTarget).data("name"),f=d.getRowById(a(b.currentTarget).data("pk"));f||(f=d.getRowById(0)),a(this).data("value",c.submitValue);var g=f[e];f[e]=c.submitValue,d.options.onEditableSave(e,f,g,a(this))}),f.off("shown").on("shown",b,function(b,c){var d=b.data,e=a(b.currentTarget).data("name"),f=d.getRowById(a(b.currentTarget).data("pk"));f||(f=d.getRowById(0)),d.options.onEditableShown(e,f,a(this),c)}),f.off("hidden").on("hidden",b,function(b,c){var d=b.data,e=a(b.currentTarget).data("name"),f=d.getRowById(a(b.currentTarget).data("pk"));f||(f=d.getRowById(0)),d.options.onEditableHidden(e,f,a(this),c)})}})}}}(jQuery),/**
...
a.each(b.columns,function(c,i){var j=a(".tablear-filter-control-"+r(i.field));if(d(i)&&e(i)&&h(j)){j.html(""),//clear
0===j.get(j.length-1).options.length&&
...
a.fn.tablear.Constructor.prototype.initFilterSelectControls=function(){q(this)};
//override
var A=a.fn.tablear.Constructor.prototype.append;a.fn.tablear.Constructor.prototype.append=function(){A.apply(this,Array.prototype.slice.apply(arguments)),q(this)};var B=a.fn.tablear.Constructor.prototype.clear;a.fn.tablear.Constructor.prototype.clear=function(){B.apply(this,Array.prototype.slice.apply(arguments)),q(this)};var C=a.fn.tablear.Constructor.prototype.reload;a.fn.tablear.Constructor.prototype.reload=function(){C.apply(this,Array.prototype.slice.apply(arguments)),q(this)};var D=a.fn.tablear.Constructor.prototype.remove;a.fn.tablear.Constructor.prototype.remove=function(){D.apply(this,Array.prototype.slice.apply(arguments)),q(this)},a.fn.tablear.Constructor.prototype.onColumnSearch=function(b){if(!(a.inArray(b.keyCode,[37,38,39,40])>-1)){n(this),this.options.pageNumber=1,this.current=1;
...
this.options.reorderableColumns&&this.makeColumnsReorderable()},a.fn.tablear.Constructor.prototype.makeColumnsReorderable=function(){var b=this;try{a(this.$element).dragtable("destroy")}catch(c){}a(this.$element).dragtable({maxMovingRows:b.options.maxMovingRows,dragaccept:b.options.dragaccept,clickDelay:1e3,beforeStop:function(){var c=[],d=[],e=[],f=[],g=-1;
//Exist columns not shown
if(b.$header.find("th").each(function(b){c.push(a(this).data("field")),d.push(a(this).data("formatter"))}),c.length<b.columns.length){f=a.grep(b.columns,function(a){return!a.visible});for(var h=0;h<f.length;h++)c.push(f[h].field),d.push(f[h].formatter)}for(var h=0;h<c.length;h++)g=L(b.columns,c[h]),g!==-1&&(e.push(b.columns[g]),b.columns.splice(g,1));b.columns=b.columns.concat(e),b.header.fields=c,b.header.formatters=d,b.resetView()}})}}(jQuery),/**
 * Nova Creator Boostrap Data Grid Extension: reorder-rows
 *
 */
function(a){// jshint ignore:line
var b=function(a,b){return{id:"customId_"+b}};a.extend(a.fn.tablear.Constructor.defaults,{reorderableRows:!1,onDragStyle:null,onDropStyle:null,onDragClass:"reorder_rows_onDragClass",dragHandle:null,useRowAttrFunc:!1,onReorderRowsDrag:function(a,b){return!1},onReorderRowsDrop:function(a,b,c){return!1}});var c=a.fn.tablear.Constructor.prototype.initHeader,d=a.fn.tablear.Constructor.prototype.initSearch;a.fn.tablear.Constructor.prototype.initHeader=function(){if(c.apply(this,Array.prototype.slice.apply(arguments)),this.options.reorderableRows){var a=this;this.options.useRowAttrFunc&&(this.options.rowAttributes=b),setTimeout(function(){a.makeRowsReorderable()},100),a.$element.on("load.rs.novacreator.bootstrap.datagrid",function(){setTimeout(function(){a.makeRowsReorderable()},100)})}},a.fn.tablear.Constructor.prototype.initSearch=function(){d.apply(this,Array.prototype.slice.apply(arguments)),!this.options.reorderableRows},a.fn.tablear.Constructor.prototype.onDrop=function(b,c){
//Call the user defined function
var d=a.map(a(b).find("tbody tr"),function(b){
//MCM commented return ($(val).data('level') + val.id).replace(/\s/g, '');
return+a(b).data("row-id")});a(b).data(".rs.novacreator.bootstrap.datagrid").options.onReorderRowsDrop.apply(b,[b,c,d])},a.fn.tablear.Constructor.prototype.makeRowsReorderable=function(){var a=this;this.$element.tableDnD({onDragStyle:a.options.onDragStyle,onDropStyle:a.options.onDropStyle,onDragClass:a.options.onDragClass,onDrop:a.onDrop,onDragStart:a.options.onReorderRowsDrag,dragHandle:a.options.dragHandle})}}(jQuery),/**
...
//Creates the plugin
a.$element.colResizable({liveDrag:a.options.liveDrag,fixed:a.options.fixed,headerOnly:a.options.headerOnly||!0,minWidth:a.options.minWidth,hoverCursor:a.options.hoverCursor,dragCursor:a.options.dragCursor,onResize:a.onResize,onDrag:a.options.onResizableDrag})};a.extend(a.fn.tablear.Constructor.defaults,{resizable:!1,liveDrag:!1,fixed:!0,headerOnly:!1,minWidth:15,hoverCursor:"e-resize",dragCursor:"e-resize",onResizableResize:function(a){return!1},onResizableDrag:function(a){return!1}});var c=a.fn.tablear.Constructor.prototype.initHeader;a.fn.tablear.Constructor.prototype.initHeader=function(){c.apply(this,Array.prototype.slice.apply(arguments));var a=this;this.options.resizable&&(//for rendering to be done
setTimeout(function(){b(a)},100),this.$element.on("load.rs.novacreator.bootstrap.datagrid",function(){setTimeout(function(){b(a)},100)}))}}(jQuery),/**
 * Nova Creator Boostrap Data Grid Extension: swipeable
 *
 */
function(a){var b=function(a){var b=a.options.swipeableOptions||{};b.swipe=a.options.onSwipe,a.$element.find(b.trigger).swipe(b)};a.extend(a.fn.tablear.Constructor.defaults,{onSwipe:function(a,b,c,d,e,f){alert("swiped")},swipeableOptions:{threshold:100,fingers:"all",allowPageScroll:"auto",trigger:"tbody tr",tap:function(b,c){
//known issue - on comboboxes, it will not work to select values with mouse
a(c).is("a")||a(c).focus()}}});var c=a.fn.tablear.Constructor.prototype.initHeader;a.fn.tablear.Constructor.prototype.initHeader=function(){c.apply(this,Array.prototype.slice.apply(arguments));var a=this;this.options.swipeable&&(setTimeout(function(){//so that the ui is done when calling initSwipeable
b(a)},100),a.$element.on("load.rs.novacreator.bootstrap.datagrid",function(){setTimeout(function(){b(a)},100)}))}}(jQuery)}(jQuery,window);