...
var e=b.$element.find('a[data-name="'+d.field+'"]');e.each(function(){var b={},c=a(this).data("maxYear"),d=a(this).data("minYear");c&&(b.maxYear=c),d&&(b.minYear=d),a(this).editable({combodate:b})}),e.off("save").on("save",b,function(b,c){var d=b.data,e=a(b.currentTarget).data("name"),f=(d.getColumnById(e),d.getRowById(a(b.currentTarget).data("pk")));a(this).data("value",c.submitValue),f[e]=c.submitValue}),e.off("shown").on("shown",b,function(a,b){}),e.off("hidden").on("hidden",b,function(a,b){})}})}}(jQuery),/**
...
setTimeout(function(){b(a)},100)}}(jQuery),/**
