...
var k=j?j(b,c,h):c[b.field].replace(/"/g,"&quot;");//escape quote
return a.each(e,i),g=[],a.each(f,function(a,b){g.push(" "+a+'="'+b+'"')}),['<a href="javascript:void(0)"',' data-name="'+e.field+'"',' data-pk="'+c[d]+'"',
//' data-value="' + result + '"',
