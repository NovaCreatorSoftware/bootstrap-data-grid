...
var f=b.$element.find('a[data-name="'+d.field+'"]');f.each(function(){var b={},d=a(this).data("maxYear"),f=a(this).data("minYear");d&&(b.maxYear=d),f&&(b.minYear=f);var g="top";c==e&&(g="left"),a(this).editable({combodate:b,placement:g})}),f.off("save").on("save",b,function(b,c){var d=b.data,e=a(b.currentTarget).data("name"),f=(d.getColumnById(e),d.getRowById(a(b.currentTarget).data("pk")));a(this).data("value",c.submitValue),f[e]=c.submitValue,d.options.onEditableSave(e,f,f[e],a(this))}),f.off("shown").on("shown",b,function(b,c){var d=b.data,e=a(b.currentTarget).data("name"),f=d.getRowById(a(b.currentTarget).data("pk"));d.options.onEditableShown(e,f,a(this),c)}),f.off("hidden").on("hidden",b,function(b,c){var d=b.data,e=a(b.currentTarget).data("name"),f=d.getRowById(a(b.currentTarget).data("pk"));d.options.onEditableHidden(e,f,a(this),c)})}})}}}(jQuery),/**
