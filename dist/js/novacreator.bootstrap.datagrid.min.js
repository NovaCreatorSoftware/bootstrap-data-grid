...
var e=b.$element.find('a[data-name="'+d.field+'"]');e.each(function(){var b={},c=a(this).data("maxYear"),d=a(this).data("minYear");c&&(b.maxYear=c),d&&(b.minYear=d),a(this).editable({combodate:b})}),e.off("save").on("save",b,function(b,c){var d=b.data,e=a(b.currentTarget).data("name"),f=(d.getColumnById(e),d.getRowById(a(b.currentTarget).data("pk")));a(this).data("value",c.submitValue),f[e]=c.submitValue,d.options.onEditableSave(e,f,f[e],a(this))}),e.off("shown").on("shown",b,function(b,c){var d=b.data,e=a(b.currentTarget).data("name"),f=d.getRowById(a(b.currentTarget).data("pk"));d.options.onEditableShown(e,f,a(this),c)}),e.off("hidden").on("hidden",b,function(b,c){var d=b.data,e=a(b.currentTarget).data("name"),f=d.getRowById(a(b.currentTarget).data("pk"));d.options.onEditableHidden(e,f,a(this),c)})}})}}(jQuery),/**
