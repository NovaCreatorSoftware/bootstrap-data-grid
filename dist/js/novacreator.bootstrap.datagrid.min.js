 ...
 *
 */
function(a){var b=function(a){var b=a.options.swipeableOptions||{};b.swipe=a.options.onSwipe,a.$element.find(b.trigger).swipe(b)};a.extend(a.fn.tablear.Constructor.defaults,{onSwipe:function(a,b,c,d,e,f){alert("swiped")},swipeableOptions:{threshold:100,fingers:"all",trigger:"tbody tr",tap:function(b,c){
