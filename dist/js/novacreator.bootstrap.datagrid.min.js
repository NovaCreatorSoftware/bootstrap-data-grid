...
var f=b.$element.find('a[data-name="'+d.field+'"]');f.each(function(){var b={},d=a(this).data("maxYear");d&&(b.maxYear=d);var f=a(this).data("minYear");f&&(b.minYear=f);var g=a(this).data("yearDescending");"undefined"!=typeof g&&(b.yearDescending=g);var h="top";c==e&&(h="left"),a(this).editable({combodate:b,placement:h})}),f.off("save").on("save",b,function(b,c){var d=b.data,e=a(b.currentTarget).data("name"),f=(d.getColumnById(e),d.getRowById(a(b.currentTarget).data("pk")));f||(f=d.getRowById(0)),a(this).data("value",c.submitValue);var g=f[e];f[e]=c.submitValue,d.options.onEditableSave(e,f,g,a(this))}),f.off("shown").on("shown",b,function(b,c){var d=b.data,e=a(b.currentTarget).data("name"),f=d.getRowById(a(b.currentTarget).data("pk"));f||(f=d.getRowById(0)),d.options.onEditableShown(e,f,a(this),c)}),f.off("hidden").on("hidden",b,function(b,c){var d=b.data,e=a(b.currentTarget).data("name"),f=d.getRowById(a(b.currentTarget).data("pk"));f||(f=d.getRowById(0)),d.options.onEditableHidden(e,f,a(this),c)})}})}}}(jQuery),/**
