 ...
 *
 */
function(a){var b=function(a){var b=a.options.swipeableOptions||{};b.swipe=a.options.onSwipe,a.$element.find("tbody tr").swipe(b)};a.extend(a.fn.tablear.Constructor.defaults,{onSwipe:function(a,b,c,d,e,f){alert("swiped")},swipeableOptions:{threshold:150}});var c=a.fn.tablear.Constructor.prototype.initHeader;a.fn.tablear.Constructor.prototype.initHeader=function(){c.apply(this,Array.prototype.slice.apply(arguments));var a=this;this.options.swipeable&&(setTimeout(function(){//so that the ui is done when calling initSwipeable
